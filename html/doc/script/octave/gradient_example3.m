...
# function
f = @(x,y) (-3*x.^2 + 2*y.^2 + 15);

# partial derivatives
px = @(x) (-6*x);   # partial derivative with respect to x
py = @(y) ( 4*y);   # partial derivative with respect to y
...
# save
#axis("auto")  # turn autoscale on
title('Gradient Example 3.')
print([imagedir 'gradient_example3.png'], '-S400,300');
